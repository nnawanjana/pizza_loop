...
public class OrderDetailEditActivity extends AppCompatActivity {
    ...
    private CardView cardViewonion, cardViewtomato;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent1 = getIntent();
        CartID = intent1.getStringExtra("CART_ID");
        ...
        Glide.with(OrderDetailEditActivity.this).load(imgurl).into(pimg);
        Pname.setText(name1);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OrderDetailEditActivity.this, CartActivity.class);
    ...
    private void editcart() {
        ...
        String URL1 = "http://" + IPAddress.IPAddress + ":8080/demo/updateCart?cartId=" + CartID + "&imageUrl=" + intent1.getStringExtra("IMG") + "&pizzaname=" + Pname.getText().toString() + "&pizzacrust=" + crust + "&pizzasize=" + pizzasize + "&extra=" + extra + "&qty=" + qty + "&totalprice=" + cartprice + "&status=1";
    ...
    public void onBackPressed() {
        Toast.makeText(OrderDetailEditActivity.this, "Please click the Back Arrow", Toast.LENGTH_LONG).show();
    }
